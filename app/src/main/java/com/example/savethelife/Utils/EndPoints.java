package com.example.savethelife.Utils;

public class EndPoints {
    private static final String base_url = "https://yccsstudents.000webhostapp.com/";

    public static final String register_url = base_url+"reg.php";
